...
function be({
  ...
  const { styleHeight: a, styleWidth: l } = (0, import_react.useMemo)(
    () => ({
  ...
  return q(() => {
    ...
    return p.observe(n, { box: e }), () => {
      p == null ? void 0 : p.unobserve(n);
    };
  }, [e, f, n, a, l]), (0, import_react.useMemo)(
    () => ({
      height: a ?? c.height,
      width: l ?? c.width
    }),
...
function ee({
  ...
  const [d, f] = (0, import_react.useState)({
    startIndexVisible: 0,
  ...
  q(() => {
    const h = (r === "vertical" ? e == null ? void 0 : e.scrollTop : e == null ? void 0 : e.scrollLeft) ?? 0;
    f(W(h));
  }, [e, r, W]), q(() => {
    if (!e)
      return;
...
function Re({
  ...
  const y = de(t), V = (0, import_react.useMemo)(
    ...
    [e]
  ), [u, z] = (0, import_react.useState)(null), k = ve(u, l), {
    getCellBounds: S,
    getEstimatedSize: W,
  ...
  (0, import_react.useImperativeHandle)(
    ...
    () => ({
      ...
      scrollToCell({
        ...
        const N = T({
          align: R,
          containerScrollOffset: (u == null ? void 0 : u.scrollLeft) ?? 0,
          index: j
        }), ge = Q({
          align: D,
  ...
  const he = (0, import_react.useMemo)(() => {
    ...
    if (n > 0 && b > 0)
      for (let R = M; R <= _; R++) {
        ...
        B.push(
          (0, import_jsx_runtime.jsx)("div", { role: "row", "aria-rowindex": R + 1, children: D }, R)
        );
      }
    return B;
  }, [
...
function Ae({
  ...
  const m = de(d), I = (0, import_react.useMemo)(
    () => (0, import_react.memo)(a, ue),
    [a]
...
function ke({
  ...
  const { map: n } = s, o = (0, import_react.useCallback)(() => {
    ...
    (f) => n.get(f),
    [n]
  ), a = (0, import_react.useCallback)((f, p) => {
    r((b) => {
      if (b.map.get(f) === p)
        return b;
